...
function initCitySelector(){
    ...
    for(var city in aqiSourceData){
        ...
        option += '<option value="'+ index +'">'+ city +'</option>';
        index++;
    }
...
function initAqiChartData(){
    // 将原始的源数据处理成图表需要的数据格式
    // var cityName = document.getElementById("city-select").children[pageState.nowSelectCity].innerHTML;
    // var data = aqiSourceData[cityName];
